 ...
 * Update: Refined Hero Headline kerning to fix disconnected "R" in MASTER.
 * Integration: Stripe Checkout on PRESSURE + "The Field Report" + Plumber26 logic.
 */
...
const App = () => {
  ...
  const [isPurchasing, setIsPurchasing] = useState(null); // ID of product being processed
  ...
  const handlePurchase = async (priceId, productId) => {
    ...
    try {
      ...
      if (data.url) {
        ...
        console.error("Checkout Leak:", data.error);
    ...
    <div className="bg-[#1a0f0a] text-[#f4e4bc] font-serif relative overflow-x-hidden min-h-screen">
          ...
          <div className="text-center lg:text-left">
            <ScrollReveal>
              <div className="flex flex-col items-center lg:items-start">
                ...
                {/* HEADLINE REPAIR: tracking-tight (instead of tighter) to fix disconnected 'R' */}
                <h1 className="text-6xl sm:text-7xl md:text-9xl font-black tracking-tight mb-10 leading-[0.9] uppercase italic text-white drop-shadow-2xl text-center lg:text-left w-full break-words">
                ...
                <div className="mt-12 relative flex items-center justify-center lg:justify-start">
                  ...
                  <button onClick={() => scrollTo(depotRef)} className="bg-[#c58158] text-[#1a0f0a] px-10 sm:px-16 py-5 sm:py-6 font-black uppercase tracking-widest sm:tracking-[0.2em] shadow-[0_10px_0_#8c5a3d] rounded-lg hover:translate-y-[2px] active:translate-y-[8px] transition-all flex items-center gap-3 italic text-center text-lg text-center">
        ...
        <ScrollReveal>
          <div className="max-w-6xl mx-auto overflow-hidden">
            <div className="mb-16 space-y-4 text-center">
               ...
               <h1 className="text-5xl sm:text-7xl md:text-9xl font-black tracking-tight text-white leading-[1.0] sm:leading-[0.95] uppercase italic break-words text-center">SYSTEM <br className="sm:hidden" /> <span className="text-[#d4af37]">TROUBLE SHOOTING</span></h1>
              ...
              {[
                ...
                <div key={i} className="bg-[#2a1b15]/40 border-2 border-[#c58158]/20 p-6 sm:p-10 flex flex-col hover:border-[#d4af37] transition duration-500 rounded-sm shadow-2xl group text-left">
                  ...
                  <div className="space-y-6">
                    <div className="pt-8 border-t border-[#c58158]/10 text-left"><p className="text-[10px] uppercase tracking-widest text-[#d4af37] font-black mb-3">Recommended Part:</p><p className="text-2xl sm:text-3xl font-black text-white italic uppercase tracking-tight mb-4 leading-none">{d.fix}</p><p className="text-[10px] sm:text-xs font-bold text-[#f4e4bc]/50 italic leading-relaxed uppercase text-left">{d.action}</p></div>
                  </div>
                </div>
              ))}
            </div>
        ...
        <ScrollReveal>
          <div className="max-w-6xl mx-auto overflow-hidden text-center">
            <div className="mb-16 space-y-4 text-center">
               ...
               <h1 className="text-5xl sm:text-7xl md:text-9xl font-black tracking-tight text-white leading-[1.0] sm:leading-[0.95] italic uppercase break-words text-center">THE <span className="text-[#d4af37]">FIELD</span> REPORT</h1>
            ...
            <div className="flex flex-col gap-12 sm:gap-16">
               ...
               <div className="py-16 border-y-2 border-[#c58158]/20 relative overflow-hidden bg-[#2a1b15]/20 px-4 sm:px-8 text-center text-center">
                  ...
                  <h2 className="text-2xl sm:text-5xl font-black uppercase italic tracking-tight text-white leading-[1.1] sm:leading-[0.95] mb-8 text-center text-center text-center">"Take care of your body. It's the only place you have to live."</h2>
      ...
      <section ref={teardownRef} className="px-8 py-16 sm:py-32 bg-[#1a0f0a] text-center text-center">
        <ScrollReveal>
          <div className="max-w-6xl mx-auto text-center text-center">
            <div className="mb-16 sm:mb-24 space-y-6 text-center text-center text-center text-center">
              ...
              <h1 className="text-5xl sm:text-7xl md:text-9xl font-black tracking-tight uppercase mb-10 leading-[1.0] italic text-white text-center break-words">SYSTEM <span className="text-[#d4af37]">TEARDOWN</span>.</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-stretch text-right">
              <div className="bg-[#2a1b15]/40 p-8 sm:p-16 border-2 border-[#c58158]/10 relative z-10 shadow-lg group grayscale opacity-85 hover:opacity-100 transition-all duration-500 text-right text-right">
                <div className="absolute top-6 left-6 text-[9px] sm:text-[10px] uppercase tracking-widest text-[#c58158]/60 text-left text-left text-left">Mass Market Formula</div>
                ...
                <div className="space-y-6 sm:space-y-8 italic text-right text-right">
              ...
              <div className="relative bg-[#1a0f0a] p-8 sm:p-16 border-[3px] border-[#c58158] shadow-[0_0_100px_rgba(197,129,88,0.15)] z-20 overflow-hidden text-right text-right">
                ...
                <div className="space-y-6 sm:space-y-8 relative z-10 italic text-right text-right">
      ...
      <section className="bg-[#1a0f0a] py-20 sm:py-32 px-8 border-b border-[#c58158]/10 text-center">
        <ScrollReveal>
          <div className="max-w-4xl mx-auto space-y-10 sm:space-y-12">
            <h2 className="text-3xl sm:text-6xl md:text-8xl font-black uppercase text-white tracking-tight leading-none italic text-center">STOP BUYING FILLER. <br /><span className="text-[#c58158]">UPGRADE YOUR SYSTEM.</span></h2>
       ...
       <div className="max-w-7xl mx-auto italic text-center">
          <ScrollReveal>
            <div className="mb-16 sm:mb-24 space-y-6 text-center text-center text-center text-center">
               ...
               <h1 className="text-5xl sm:text-7xl md:text-9xl font-black tracking-tight text-white leading-none text-center">THE <span className="text-[#d4af37]">SUPPLY</span> DEPOT</h1>
               <div className="flex items-center gap-3 justify-center text-[#d4af37] animate-pulse text-center"><Truck size={20} sm:size={24} /><span className="text-xs sm:text-sm font-black uppercase tracking-[0.5em] text-center">All orders include free express shipping</span></div>
            </div>
            <div className="grid md:grid-cols-3 gap-8 sm:gap-10 text-center">
               {[
                 ...
                 <div key={p.id} className="bg-[#2a1b15]/40 border-2 border-[#c58158]/20 p-8 sm:p-10 hover:border-[#d4af37] transition duration-500 flex flex-col items-center group rounded-sm shadow-2xl relative overflow-hidden text-center text-center text-center text-center">
                    ...
                    <div className="w-full aspect-square bg-[#1a0f0a] border border-[#c58158]/20 mb-6 sm:mb-8 flex items-center justify-center relative shadow-inner overflow-hidden text-center"><img src={p.imgOverride} alt={p.name} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" /></div>
                    ...
                    <div className="mt-auto w-full space-y-4 sm:space-y-6 pt-6 sm:pt-8 border-t border-[#c58158]/20 text-center">
                       <div className="flex flex-col items-center gap-2 text-center">
                          <p className="text-3xl sm:text-4xl font-black italic text-white text-center">${p.price}</p>
                          <span className="text-[10px] text-[#c58158] font-black uppercase tracking-widest text-center">Free Express Shipping</span>
                       </div>
                       <div className="space-y-3 sm:space-y-4 text-center">
                         <button 
                          onClick={() => p.priceId && handlePurchase(p.priceId, p.id)}
                          disabled={isPurchasing === p.id}
                          className="w-full bg-[#c58158] text-[#1a0f0a] py-3 sm:py-4 font-black uppercase tracking-widest text-xs hover:bg-[#d4af37] shadow-[0_8px_0_#8c5a3d] active:translate-y-[8px] transition-all text-center flex items-center justify-center gap-2 disabled:opacity-70"
                         >
      ...
      <footer className="bg-[#0f0a08] py-16 sm:py-24 px-10 text-center italic border-t border-[#c58158]/10 text-center">
         <div className="max-w-5xl mx-auto space-y-10 sm:space-y-12 flex flex-col items-center text-center">
            ...
            <p className="text-[10px] sm:text-xs font-black uppercase tracking-[0.2em] text-[#c58158]/30 leading-relaxed max-w-2xl mx-auto italic text-center">
...
const TestimonialCard = ({ testimonial }) => (
  <div className="bg-[#2a1b15]/40 border-2 border-[#c58158]/20 p-6 sm:p-8 flex flex-col hover:border-[#d4af37] transition duration-300 relative rounded-sm shadow-xl h-full text-left">
    <div className="absolute top-4 right-4 opacity-10 text-left text-left"><Quote size={32} sm:size={40} className="text-[#c58158]" /></div>
    ...
    <p className="text-[#f4e4bc] text-sm sm:text-base font-bold italic leading-relaxed mb-8 relative z-10 text-left text-left">"{testimonial.text}"</p>
    <div className="mt-auto border-t border-[#c58158]/10 pt-6 text-left text-left">
      <p className="text-[#d4af37] font-black uppercase tracking-widest text-xs italic text-left">{testimonial.name}</p>
      <div className="flex justify-between items-center mt-1 text-left text-left">
        <p className="text-[#c58158]/60 font-bold uppercase text-[8px] sm:text-[9px] tracking-widest text-left text-left">{testimonial.location}</p>
        <span className="text-[8px] font-black bg-[#c58158]/10 px-2 py-0.5 border border-[#c58158]/20 text-[#c58158] rounded-full text-left text-left text-left">{testimonial.product}</span>
      </div>
    </div>
  </div>
);
